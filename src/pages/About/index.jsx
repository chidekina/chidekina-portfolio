    ...
    return (
        <Container flexDirection="flex-row">
            <div className="pl-18 py-12 w-1/3">
                <img
                    className={`w-sm rounded-full border-solid border-4 border-accent h-fit transition-all duration-700 ease-out hover:scale-105 hover:shadow-2xl hover:border-white ${showPhoto
            ...
            <div className="flex flex-col justify-center items-center px-10 gap-8 text-center w-2/3">
                <h1 className={`text-[1.3rem] font-bold text-accent transition-all duration-700 ease-out ${showTitle
                ...
                <h2 className={`font-bold text-xl transition-all duration-700 ease-out ${showConnectTitle
                        ? 'transform translate-y-0 opacity-100'
                        : 'transform translate-y-8 opacity-0'
                    }`}>
                    Conecte-se comigo:
